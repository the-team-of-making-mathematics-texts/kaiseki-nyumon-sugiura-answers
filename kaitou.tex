...
\begin{leftbar}
    ...
    \begin{align*}
         ...
         &\le \frac{|a|^n}{n!} \\
         &= \frac{|a|^{N}}{N!} \cdot \frac{|a|}{N+1} \cdot \frac{|a|}{N+1} \cdots \frac{|a|}{n} \\
...
\begin{leftbar}
    ...
    よって，
    \[
        -\left(\frac{1}{2}\right)^m < \frac{n!}{n^n} <\left(\frac{1}{2}\right)^m
    \]
...
\begin{leftbar}
    ...
    \[
    \frac{1}{\sqrt{n+1} + \sqrt{n}} < \frac{1}{\sqrt{n}} \le \frac{1}{n}
    \]
    であり，
    \[
        0< \sqrt{n+1} - \sqrt{n} <\frac{1}{n}
    \]
...
\begin{leftbar}
    \begin{proof}
        ...
        とする．これにより．
        \[
            \frac{e^{\theta}}{n+1} = m \cdot (n+1)! - \sum_{k=0}^{n} \frac{n!}{k!}
        \]
        であり，$m \cdot (n+1)! - \sum_{k=0}^{n} \frac{n!}{k!} \in \mathbb{Z}$であるから，$\frac{e^{\theta}}{n+1} \in \mathbb{Z}$である．
